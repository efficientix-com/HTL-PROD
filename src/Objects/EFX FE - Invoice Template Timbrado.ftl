                            ...
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_info_location_pdf == true>
                                    <#if record.custbody_efx_fe_logoloc?has_content>
                                        ...
                                        <img width="700" height="70" src="${urldir}"/>
                                    </#if>
                                <#else>
                                ...
                                <#else>
                                    ...
                                    <#else>
                                        ...
                                        <#elseif companyInformation.logoUrl?length != 0>
                                            <img width="70" height="70" src="${companyInformation.logoUrl}"/>
                                        </#if>
                                    </#if>
                                </#if>
                            </#if>
            ...
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    <td colspan="14" rowspan="2"
                        ...
                        <br/><br/><b>RFC:</b> ${dataXML.Receptor.atributos.Rfc}<br/>
            ...
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    <td colspan="14" rowspan="2"
                        ...
                        <br/><br/><b>RFC:</b> ${record.custbody_efx_fe_kiosko_rfc?upper_case}
                        <br/>
                        <#if record.entity.custentity_mx_sat_industry_type?has_content>
                                <br /><b>Regimen Fiscal:</b> ${record.entity.custentity_mx_sat_industry_type?upper_case}
                            </#if>
        ...
        <#else>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <#if record.entity.custentity_mx_sat_registered_name?has_content>
                    <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">${record.entity.custentity_mx_sat_registered_name}<br/><br/><b>RFC:</b> ${record.custbody_mx_customer_rfc?upper_case}
                        <br/>
                        <#if record.entity.custentity_mx_sat_industry_type?has_content>
                                <br /><b>Regimen Fiscal:</b> ${record.entity.custentity_mx_sat_industry_type?upper_case}
                            </#if>
                        ...
                        <#else>
                        <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;"><#if record.entity.altname?has_content>${record.entity.altname}<#elseif record.entity.companyname?has_content><#else>${record.entity.firstname} ${record.entity.lastname}</#if><br/><br/><b>RFC:</b> ${record.custbody_mx_customer_rfc?upper_case}
                        <br/>
                        <#if record.entity.custentity_mx_sat_industry_type?has_content>
                                <br /><b>Regimen Fiscal:</b> ${record.entity.custentity_mx_sat_industry_type?upper_case}
                            </#if>
    ...
    <#list record.item as item>
        ...
        <#else>
          ...
          <#if item.itemtype != "Discount">
            <#assign "nombre_item" = nombre_item + [item.item]>
            </#if>
    </#list>
    <#assign "importe_discount" = importe_discount+ [0]>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#if dataXML.Conceptos.Concepto?is_sequence>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="5"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Número de Parte
                    </th>
                ...
                <#list dataXML.Conceptos.Concepto as Conceptos>
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="5"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;"><#if nombre_item?size gte linexml>${nombre_item[linexml-1]}</#if></td>
            ...
            <#else>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="5" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Número de Parte
                    </th>
                ...
                <tr>
                    ...
                    <td align="center" colspan="5"
                        style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nombre_item[0]}</td>
                    <td align="center" colspan="4" line-height="150%"
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="5"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${item.item}</td>
                            <td align="center" colspan="4" line-height="150%"
...
<tr>
    ...
    <td align="center" colspan="5" line-height="150%" style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding:0;">${item.item}</td>
